...
Page({
  data: {
    ...
    dayStyle: [{
      ...
      },
      {
        ...
        color: '#FFFFFF',
        background: 'linear-gradient(to right, #498fe1 50%, #f5a623 50%)'
      },
      {
        month: 'current',
        day: new Date().getDate() + 2,
        color: '#FFFFFF',
        background: 'linear-gradient(to right, #498fe1 20%, #ec4412 60%, #f5a623 80%)'
      },
      {
        month: 'current',
  ...
  gotopublish: function () {
    wx.navigateTo({
      url: '../../pages/apply/newApply/newApply',
    })
  },
